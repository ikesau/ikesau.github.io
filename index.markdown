...
<a href="/blog.html"><h3 style='display: inline-block; margin-bottom: 0'>blog</h3></a> <a href="/reblogs.html"><h5 style='display: inline-block; margin-bottom: 0'>(reblogs)</h5></a>
  ...
  <img class="dont-ask-what-just-put-it-in-the-grease" loading="lazy" src="assets/images/magic-cauldron.gif" alt="underneath burrard bridge"/>
  ...
  <img src="assets/images/lauft.svg" loading="lazy" alt="je n'ai plus peur de perdue mon temps"/>

<a href="a-quote.html">get a quote</a>

  <img width="100%" src="assets/images/splash.png" loading="lazy" alt="a generative black and white image that resembles waves emanating from a pond's centre"/>
  <img width="100%" src="assets/images/rocket.png" loading="lazy" alt="another generative black and white image that resembles a team rocket base"/>
  <img style="width: 100%; max-height: unset; margin-left: 0; margin-right: 0" src="/assets/images/dorde martinovic incident tshirt.webp" loading="lazy" alt="a templated white tshirt design with the dorde martinovic incident wikipedia article printed on the front">
  <h2>bye</h2>
</div>
